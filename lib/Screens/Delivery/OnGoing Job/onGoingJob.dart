...
class _OnGoingJobScreenState extends State<OnGoingJobScreen> {
  ...
  Future<void> initializeData() async {
    ...
    job = await Database_Service(userId: _auth_service.getUserId())
        .fetchRiderJobData();
    if (job.isEmpty) {
      setState(() {
        noJobFound = true;
  ...
  int calculateRemainingTime() {
    ...
    DateTime delTime = DateFormat('dd/MM/yyyy hh:mm a').parse(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: const Padding(
                            ...
                            child: Icon(Icons.motorcycle, size: 30.0,
                              color: Colors.green,),
                          )),
                      Container(
                        decoration: BoxDecoration(
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    bool isJobCompleted = await Database_Service(
                        ...
                        .orderDeliveredCompleteRide(
                        totalCharges, jobId, orderId, customerId);
                    if (isJobCompleted) {
